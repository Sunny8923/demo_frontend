    ...
    final actions = [
      ...
      _ActionCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const CreateRecruiterScreen()),
          );
        },
      ),
      _ActionCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const PendingPartnerScreen()),
          );
        },
      ),
      _ActionCard(
      ...
      _ActionCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => UploadCandidatesScreen()),
          );
        },
      ),
      _ActionCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => ViewCandidatesScreen()),
          );
        },
      ),
    ];
            ...
            builder: (context, constraints) {
              ...
              return GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  crossAxisSpacing: 12,
                  mainAxisSpacing: 12,
                  childAspectRatio: width < 500 ? 1.1 : 1.3,
                ),
