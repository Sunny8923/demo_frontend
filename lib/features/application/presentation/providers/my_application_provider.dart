...
final myApplicationProvider =
    AsyncNotifierProvider<MyApplicationNotifier, List<ApplicationModel>>(
      MyApplicationNotifier.new,
    );

class MyApplicationNotifier extends AsyncNotifier<List<ApplicationModel>> {
